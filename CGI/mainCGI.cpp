...
std::string mainCGI(std::string urlCgi, int clientSocket, Client &dataClient) {
    ...
    std::string spath ="/Users/mserrouk/Desktop/webServer/CGI/hello_script.php";
    std::string sfile = "/Users/mserrouk/Desktop/webServer/CGI/hello_script.php";
    ...
    //std::string path = "/Users/mserrouk/Desktop/fixweb/CGIfix/test.py";
